...
export const RegisterForm = () => {
  ...
  const handleGoogleLogin = () => {
    ...
    globalThis.window.location.href = `${apiUrl}/auth/google/callback`;
  };
    ...
    >
      <div className="mb-8 flex flex-col items-center text-center">
        ...
        <p className="text-sm text-neutral-500">
          Join Terra Coffee for an exclusive experience.
        </p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="bg-primary hover:bg-primary/90 shadow-primary/20 mt-4 h-12 w-full rounded-xl text-base font-medium text-white shadow-lg transition-all active:scale-[0.98]"
          >
            {isLoading ? (
